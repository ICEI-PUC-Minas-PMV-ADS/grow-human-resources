...
namespace GHR.Persistence.Migrations
{
    ...
    [Migration("20220530000541_Initial-Review-depto2")]
    partial class InitialReviewdepto2
    {
            ...
            modelBuilder.Entity("GHR.Domain.DataBase.Departamentos.Departamento", b =>
                {
                    ...
                    b.Property<string>("GerenteAdministrativo")
                        .HasColumnType("TEXT");

                    b.Property<string>("GerenteOperacioal")
                        .HasColumnType("TEXT");
